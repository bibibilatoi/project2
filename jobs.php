                ...
                <ul>
                    ...
                    <li>
                        ...
                        <section class="department-content">
                            ...
                            <section class="job-positions">
                                <input type="checkbox" id="job-ai-1" name="job-ai-checkbox">
                                <label for="job-ai-1">AI Engineer</label>
                                <div class="job-descriptions">
                                    <dl class="job-basic-info">
                                        <dt>Reference Number:</dt><dd>AI01</dd>
                                        <dt>Salary Range:</dt><dd>USD 120,000 - 150,000 per year</dd>
                                        <dt>Reports To:</dt><dd>Head of AI and Orbital Systems</dd>
                                    </dl>
                                    
                                    <h4>Brief Description</h4>
                                    <p>
                                        The AI and Data Systems team at SpeedX develops intelligent models that power real-time orbital decision-making, spacecraft autonomy, and earth observation. 
                                    </p>

                                    <h4>Key Responsibilities</h4>
                                    <ul>
                                        <li>Develop novel geospatial data processing models to extract valuable information from raw and partially processed sensor data.</li>
                                        <li>Create highly reliable software and machine learning systems that task remote sensor payloads on hundreds of satellites in low earth orbit and process the collected information.</li>
                                        <li>See your modeling work and software through from start-to-finish: from figuring out the core needs to prototyping, developing, and testing; to production rollout and beyond.</li>
                                        <li>Build tools that enable the team to work more efficiently, and that help build software systems that are secure, reliable, and autonomous.</li>
                                    </ul>

                                    <h4>Basic Qualifications</h4>
                                    <ul>
                                        <li>Bachelor's degree in computer science, engineering, math, or scientific discipline; OR 2+ years of professional experience in software development in lieu of a degree.</li>
                                        <li>1+ years of experience in applied machine learning engineering, full-stack development, and data science.</li>
                                        <li>1+ years of development experience in Python, C, or C++.</li>
                                    </ul>

                                    <h4>Preferred Skills and Experience</h4>
                                    <ul>
                                        <li>Experience applying modern computer vision algorithms at scale.</li>
                                        <li>Experience with production ML systems or software used in real-world applications.</li>
                                        <li>Experience working with cloud environments (AWS, GCP, Azure).</li>
                                        <li>Experience with Linux server environments, scripting, and system configuration.</li>
                                        <li>Experience with Kubernetes or similar container orchestration frameworks.</li>
                                        <li>Experience with PostgreSQL or implementing highly performant databases.</li>
                                        <li>Ability to obtain and maintain a Top Secret or Top Secret SCI clearance.</li>
                                    </ul>

                                    <h4>Additional Requirements</h4>
                                    <ul>
                                        <li>Note that an active clearance may provide the opportunity for you to work on sensitive SpeedX missions; if so, you will be subject to pre-employment drug and random drug and alcohol testing.</li>
                    ...
                    <li>
                        ...
                        <section class="department-content">
                            ...
                            <div class="job-listing-container">
                                ...
                                <section class="job-positions">
                                    <input type="checkbox" id="job-ops-4" name="job-ops-checkbox">
                                    <label for="job-ops-4">Network Security Engineer</label>
                                    <div class="job-descriptions">
                                        <dl class="job-basic-info">
                                            <dt>Reference Number:</dt><dd>MO04</dd>
                                            <dt>Salary Range:</dt><dd>USD 110,000 - 145,000 per year</dd>
                                            <dt>Reports To:</dt><dd>Chief Information Security Officer (CISO)</dd>
                                        </dl>
                                        
                                        <h4>Brief Description</h4>
                                        <p>
                                            Network security engineers at SpeedX design, build, and maintain the systems that protect our satellites.
                                        </p>

                                        <h4>Key Responsibilities</h4>
                                        <ul>
                                            <li>Develop and implement network security tools</li>
                                            <li>Produce threat models and assess risk around existing configurations</li>
                                            <li>Provide subject matter expertise on network security, firewalls and industry best practices</li>
                                            <li>Manage firewall configurations within the SpeedX enterprise network based on operational requirements</li>
                                            <li>Analyze and proactively come up with creative network solutions for operational needs that present security challenges</li>
                                            <li>Document and formalize security processes</li>
                                            <li>Manage and maintain network security systems by applying system patches and other periodic maintenance tasks</li>
                                            <li>Work with other SpeedX teams to determine functional needs, develop secure architectures, and communicate security best practices and policies</li>

                                        </ul>

                                        <h4>Basic Qualifications</h4>
                                        <ul>
                                            <li>Bachelor's degree in Computer Science, Cybersecurity, or related technical field; or equivalent practical experience.</li>
                                            <li>2+ years of experience securing networks, IT infrastructure, applications, endpoints, and/or APIs</li>
                                            <li>5+ years of experience hardening Windows, MacOS, and/or Linux operating systems</li>
                                        </ul>

                                        <h4>Preferred Skills and Experience</h4>
                                        <ul>
                                            <li>Relevant certifications (CISSP, CCNP Security, CEH, OSCP, etc.)</li>
                                            <li> Strong understanding of network security technologies, their operation and limitations (firewalls, IDS/IPS, VPNs, access control, and SIEM-based monitoring, etc.)</li>
                                            <li>Python programming and automation ability</li>
                                            <li>Experience testing and implementing changes in a production environment</li>
                                            <li>Adept at learning new technologies and systems</li>
                                        </ul>

                                        <h4>Additional Requirements</h4>
                                        <ul>
                                            <li>This role requires you to be onsite. Hybrid or remote work will not be considered</li>
                                            <li>Must be willing to work extended hours and weekends as needed to support mission timelines</li>
                                        </ul>
                                    </div>
                                </section>
