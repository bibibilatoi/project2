		...
		<main>
			<div class="container">
				...
				<dl>
					...
					<dd>Shared Responsibility: Home Page, enhancement.php, CSS File, eoi and manager sql</dd>
					<dd>Individual Responsibility: About Us page (about.php), manage.php, views_eoi.php, manage_process.php</dd>
