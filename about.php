		...
		<div class="container">
			<main>
				...
				<div class="student_information">
					<ul class="Student_information">
						<li class = "about-student-id">
						<ul>
							<li>Trinh Thai Anh Tuan</li>
							<li class="ID">ID: SWH03039</li>
						</ul>
						</li>
				...
				<dl>
					...
					<dd>Individual Responsibility: About Us page (about.php), manage, login, and register pages</dd>

					<dt>Vu Hoang Long</dt>
					<dd>Shared Responsibility: Home Page, CSS File</dd>
					<dd>Individual Responsibility: Job Positions page (jobs.php), SQL tables and logic</dd>
					...
					<dt>Dang Thien An</dt>
					<dd>Shared Responsibility: Home Page, CSS File, refine some web designs</dd>
					<dd>Question Poster</dd>
				</dl>
