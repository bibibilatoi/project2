...
4. Finally after data insertion, the page is redirect to the **login.php** page.
...
- We also validate errors server side with **process_eoi.php** and send back the errors as a list to display in the **apply.php** page
